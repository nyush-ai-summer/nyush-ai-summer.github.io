...
![csdse]({{ site.url }}{{ site.baseurl }}/assets/images/blog-images/csdse2.png){: style="width: 90%;"}
...
![center]({{ site.url }}{{ site.baseurl }}/assets/images/blog-images/aicenter2.png){: style="width: 90%;"}
